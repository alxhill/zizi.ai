    ...
    return (
      <div className="about-page">
        ...
        <div className="about" ref={this.aboutPageContent}>
          ...
          <video controls width="100%" controlsList="nofullscreen nodownload noremoteplayback" poster="vids/making-of.jpg">
            <source src={"vids/making-of.mp4"} />
          </video>
          ...
          <img className="diagram" src="img/About/project-zizi-and-me.jpg" draggable="false" alt="Closeup deepfake" />
          ...
          <img className="diagram" src="img/About/project-zizi19.jpg" draggable="false" alt="Closeup deepfake" />
