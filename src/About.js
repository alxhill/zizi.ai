  ...
  return (
    <div className="about-page">
      ...
      <div className="about">
        ...
        <img src="img/About/diagram-gen-close-small.gif" draggable="false" />
        <img src="img/About/diagram-gen-full-small.gif" draggable="false" />
        <p>
        ...
        <p>
          <sup className="footnote" id="fn2">
            2. an accuracy score calculated using the gradient descent learning
            algorithm
        ...
        <p>
          <sup className="footnote" id="fn3">
            ...
            2018. It uses OpenPose (2018) for skeleton tracking and DensePose
            (2018) for silhouette estimation. This technique also uses Flownet
            (2016) to take into account the motion in the video.
        ...
        <p>
          <sup className="footnote" id="fn4">
            4. See Hamidi, F., Scheuerman, M.K. and Branham, S.M., 2018, April.
            Gender recognition or gender reductionism? The social implications
            of embedded gender recognition systems. In Proceedings of the 2018
