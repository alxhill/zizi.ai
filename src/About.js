    ...
    return (
      <div className="about-page">
        ...
        <div className="about">
          ...
          <i>
            <p>
              "My latest work aims to bring together two things I love,
              artificial intelligence, and the world of Drag performance. In an
              entertaining and humorous way Drag has allowed me to dig into some
              of the social issues built into machine learning technology.
            </p>
            <p>
              Drag is a brilliant lens through which we can explore and expose
              the layers of technical construction and social bias inherent to
              AI.
            </p>
            <p>
              Working closely with friends from the London drag scene, in Zizi
              we have created a ‘deep-fake’ virtual cabaret. This deep-fake tech
              has enabled us to collaborate with machine learning to do drag,
              demonstrating how drag queens, drag kings and drag things can
          ...
          <p>
            ...
            specifically deep-fake technology, has been used to construct all
          ...
          <p>
            ...
            skeleton tracking (illustrated below). The neural network aims to
            ...
            Once it has learnt to do this it can then start producing
            deep-fakes.
          </p>
          <p>
          ...
          <p>
            Once the neural network has been training for, let's say, three
            days, it is ready to be fed new movements. Anyone can now control
            the deep-fake body by running skeleton tracking on a new video and
            then feeding these into the neural network.
          </p>
          <p>
          ...
          <p>
            The ‘Zizi’ character was created by simultaneously training on
            images of all of the performers. Not knowing how to differentiate
            between the bodies, the result is an amalgamation, a ‘queering’ of
            the data.
          </p>
          <p>
          ...
          <p>
            ...
            techno-activist method of dirtying and obfuscating the systems used
          ...
          <p>
            <sup className="footnote" id="fn2">
              2. an accuracy score calculated using the gradient descent
              learning algorithm
          ...
          <p>
            <sup className="footnote" id="fn3">
              3. Video-to-Video Synthesis is a conditional generative
              adversarial network (cGAN) developed by Wang et al. (Nvidia &amp;
              MIT), NeurIPS, 2018. It uses OpenPose (2018) for skeleton tracking
              and DensePose (2018) for silhouette estimation. This technique
              also uses Flownet (2016) to take into account the motion in the
              video.
          ...
          <p>
            <sup className="footnote" id="fn4">
              4. See Hamidi, F., Scheuerman, M.K. and Branham, S.M., 2018,
              April. Gender recognition or gender reductionism? The social
              implications of embedded gender recognition systems.
          ...
          <p>
            <sup className="footnote" id="fn5">
              5. Excavating AI: The Politics of Images in Machine Learning
              Training Sets, Kate Crawford and Trevor Paglen
          ...
          <p>
            ...
            Elwes exploring the intersection of Artificial Intelligence (A.I.)
            and drag performance. Drag challenges gender and explores otherness,
            while A.I. is often mystified as a tool and contains social bias.
            Zizi combines them through a deep fake, synthesised drag identity
            created using machine learning. The project explores what AI can
            teach us about drag, and what drag can teach us about A.I.
          </p>
          <hr />
          <h2>'Zizi &amp; Me' 2020</h2>
          <iframe
