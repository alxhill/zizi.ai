...
let performers = {
  ...
  sister: {
    ...
    bio: "RuPaul's Drag Race UK, Season 2. Sister Sister is a visual spectacle and comedy queen residing in Liverpool, where the river Mersey runs... (because if it walked it would get stuck talking to her).",
    n: 12
  },
  lilly: {
    id: "lilly",
